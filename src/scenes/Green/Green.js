...
export default class Green extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    if (
      ...
      nextProps.navigation.state.params.name
    ) {
      return false;
    }
    return true;
  ...
  render() {
    ...
    return (
      <View style={styles.conteiner}>
        <ScrollView>
          <ItemHeader title={params.name} image={params.picture} />
          ...
          <View style={styles.rowConteiner}>
            ...
            <Text style={[styles.text]}>{params.sun}</Text>
          </View>
          ...
          <View style={styles.rowConteiner}>
            ...
            <Text style={[styles.text]}>{params.distancePlants}</Text>
          </View>
          <View style={styles.rowConteiner}>
            <Text style={[styles.focus, styles.text]}>
              Distanza tra le file:
            </Text>
            <Text style={[styles.text]}>{params.distanceFiles}</Text>
          </View>
          <View style={styles.rowConteiner}>
            <Text style={[styles.focus, styles.text]}>Litraggio vaso:</Text>
            <Text style={[styles.text]}>{params.literGround}</Text>
          </View>
          ...
          <View style={styles.textConteiner}>
            ...
            <Text style={styles.text}>{params.climate}</Text>
          </View>

          <View style={styles.textConteiner}>
            <Text style={styles.subTitle}>Terreno</Text>
            <Text style={styles.text}>{params.ground}</Text>
          </View>

          <View style={styles.textConteiner}>
            <Text style={styles.subTitle}>Fertilizzazione</Text>
            <Text style={styles.text}>{params.fertilization}</Text>
          </View>

          <View style={styles.textConteiner}>
            <Text style={styles.subTitle}>Apporto d'acqua</Text>
            <Text style={styles.text}>{params.waterSupply}</Text>
          </View>
        </ScrollView>
      </View>
    );
